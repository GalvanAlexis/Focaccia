...
@section('content')
<!-- CSS específico para Dashboard Admin -->
<link rel="stylesheet" href="{{ asset('assets/css/admin-dashboard.css') }}">

<style>
/* Estilos específicos para pedidos con nueva paleta */
.pedido-card {
    background: linear-gradient(135deg, var(--focaccia-light) 0%, rgba(242, 197, 114, 0.05) 100%);
    border: 2px solid var(--focaccia-primary);
    border-radius: 15px;
    margin-bottom: 15px;
    padding: 15px;
    box-shadow: 0 4px 15px rgba(191, 108, 59, 0.15);
    transition: all 0.3s ease;
}

.pedido-card:hover {
    transform: translateY(-3px);
    box-shadow: 0 8px 25px rgba(191, 108, 59, 0.25);
}
...
.search-input {
    background: var(--focaccia-light) !important;
    border: 1px solid var(--focaccia-primary) !important;
    color: var(--focaccia-dark) !important;
...
<section class="py-4" style="background-color: var(--focaccia-light); min-height: 100vh;">
