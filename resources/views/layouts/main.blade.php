  ...
  <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
    <div class="container">
      <a class="navbar-brand" href="{{ url('/') }}" id="logo-link" data-caja-chica-url="{{ url('admin/caja-chica') }}">
        <img src="{{ asset('assets/images/logo.png') }}" alt="Logo La Bartola">
        La Bartola
      </a>
  ...
  <footer class="text-center mt-5">
    <div class="container">
      ...
      <div class="mt-2">
        ...
        <a href="https://www.facebook.com/profile.php?id=61584290244988" target="_blank" class="text-warning me-3"><i class="bi bi-facebook"></i></a>
